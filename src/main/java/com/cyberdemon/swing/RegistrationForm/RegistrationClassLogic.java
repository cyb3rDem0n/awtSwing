...
public class RegistrationClassLogic extends RegistrationClass {
	String gender;
				...
				if (nameField.getText().equals(""))
					...
					try {
						if (r >= 0) {
							...
							updateStatement.setString(4, contactField.getText());
